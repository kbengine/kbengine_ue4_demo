...
void SpacesBase::onGetBase()
{
	...
	pBaseEntityCall = new EntityBaseEntityCall_SpacesBase();
...
void SpacesBase::onGetCell()
{
	...
	pCellEntityCall = new EntityCellEntityCall_SpacesBase();
...
void SpacesBase::onRemoteMethodCall(Method* pMethod, MemoryStream& stream)
{
}

void SpacesBase::onUpdatePropertys(Property* pProp, MemoryStream& stream)
{
