...
void EntityDef::initScriptModules()
{
	...
	ScriptModule* pMonsterModule = new ScriptModule("Monster", 3);
	EntityDef::moduledefs.Add(TEXT("Monster"), pMonsterModule);
	EntityDef::idmoduledefs.Add(3, pMonsterModule);
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(moveSpeed / 22).");
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(recvDamage / 29).");

	ScriptModule* pNPCModule = new ScriptModule("NPC", 4);
	EntityDef::moduledefs.Add(TEXT("NPC"), pNPCModule);
	EntityDef::idmoduledefs.Add(4, pNPCModule);
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(moveSpeed / 33).");
