...
ENTITYDEF_PROPERTY_WITH_SETMETHOD_REGISTER(Avatar, name);

ENTITYDEF_PROPERTY_REGISTER(Avatar, uid);
ENTITYDEF_PROPERTY_REGISTER(Avatar, utype);
ENTITYDEF_PROPERTY_WITH_SETMETHOD_REGISTER(Avatar, modelID);
ENTITYDEF_PROPERTY_WITH_SETMETHOD_REGISTER(Avatar, modelScale);
