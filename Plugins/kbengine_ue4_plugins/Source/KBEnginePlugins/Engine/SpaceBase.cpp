...
void SpaceBase::onGetBase()
{
	...
	pBaseEntityCall = new EntityBaseEntityCall_SpaceBase();
...
void SpaceBase::onGetCell()
{
	...
	pCellEntityCall = new EntityCellEntityCall_SpaceBase();
...
void SpaceBase::onRemoteMethodCall(Method* pMethod, MemoryStream& stream)
{
}

void SpaceBase::onUpdatePropertys(Property* pProp, MemoryStream& stream)
{
