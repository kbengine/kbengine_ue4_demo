...
void SpawnPointBase::onGetBase()
{
	...
	pBaseEntityCall = new EntityBaseEntityCall_SpawnPointBase();
...
void SpawnPointBase::onGetCell()
{
	...
	pCellEntityCall = new EntityCellEntityCall_SpawnPointBase();
...
void SpawnPointBase::onRemoteMethodCall(Method* pMethod, MemoryStream& stream)
{
}

void SpawnPointBase::onUpdatePropertys(Property* pProp, MemoryStream& stream)
{
