...
ENTITYDEF_PROPERTY_WITH_SETMETHOD_REGISTER(NPC, name);

ENTITYDEF_PROPERTY_REGISTER(NPC, uid);
ENTITYDEF_PROPERTY_REGISTER(NPC, utype);
ENTITYDEF_PROPERTY_WITH_SETMETHOD_REGISTER(NPC, modelID);
ENTITYDEF_PROPERTY_WITH_SETMETHOD_REGISTER(NPC, modelScale);

ENTITYDEF_PROPERTY_WITH_SETMETHOD_REGISTER(NPC, entityNO);
