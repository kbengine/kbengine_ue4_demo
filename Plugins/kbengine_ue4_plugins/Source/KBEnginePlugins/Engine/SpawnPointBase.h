/*
	...
	Please inherit this module, such as: (class SpawnPoint : public SpawnPointBase)
	tools = kbcmd
*/
...
{
public:
	EntityBaseEntityCall_SpawnPointBase* pBaseEntityCall;
	EntityCellEntityCall_SpawnPointBase* pCellEntityCall;
