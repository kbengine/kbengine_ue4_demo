...
ENTITYDEF_PROPERTY_ALIAS_REGISTER(Gate, name, name_);

ENTITYDEF_PROPERTY_REGISTER(Gate, entityNO);

ENTITYDEF_PROPERTY_REGISTER(Gate, uid);
ENTITYDEF_PROPERTY_REGISTER(Gate, utype);
ENTITYDEF_PROPERTY_REGISTER(Gate, modelID);
ENTITYDEF_PROPERTY_REGISTER(Gate, modelScale);
